...
const SimilarJobItem = (props)=>{
    ...
    const {companyLogoUrl,employementType, jobDescription,location,title,rating} = jobDetails;
    return (
        <li className="similar-list-docs">
            <div className="logo-container">
                <img src={companyLogoUrl} alt="similar jobs company logo" className="company-logo-url"/>
                <div>
